...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
  <path strokeLinecap="round" strokeLinejoin="round" d="m18.75 4.5-7.5 7.5 7.5 7.5m-6-15L5.25 12l7.5 7.5" />
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          href={"/profiles"}
          className={pathname === "/profiles" ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname === "/profiles" ? activeIcon : inactiveIcon}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link
          href={"/contracts"}
          className={pathname === "/contracts" ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname === "/contracts" ? activeIcon : inactiveIcon}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link
          href={"/techstack"}
          className={
            pathname.includes("/techstack") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          href={"/catarticles"}
          className={
            pathname.includes("/catarticles") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          href={"/jobsupp"}
          className={pathname.includes("/jobsupp") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname === "/jobsupp" ? activeIcon : inactiveIcon}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <span>Job Apllication</span>
        </Link>
        <Link
          href={"/store"}
          className={pathname.includes("/store") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname === "/store" ? activeIcon : inactiveIcon}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link
          href={"/arduino"}
          className={pathname.includes("/arduino") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname === "/arduino" ? activeIcon : inactiveIcon}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link
          ...
          className={
            pathname.includes("/p-products-category")
              ? activeLink
              : inactiveLink
          }
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname === "/p-products-category" ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
